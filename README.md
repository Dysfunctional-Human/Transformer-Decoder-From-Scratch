...
Done:
(Make it so in every run, we generate a prefix that is dd-mm-yy-hours-minutes-seconds). Folder structure should be trained_models -> bigram -> prefix_bigram -> prefix_bigram.pt, results.json, plot.png
